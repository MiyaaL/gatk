...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-10-03-alpine-ce90c39c8" ## TODO remember to fetch and rebase to not clobber any other changes

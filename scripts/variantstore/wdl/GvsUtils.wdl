...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-10-04-alpine-c540120a9" ## TODO remember to fetch and rebase to not clobber any other changes

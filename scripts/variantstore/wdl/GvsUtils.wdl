...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-10-05-alpine-325f488bb" ## TODO remember to fetch and rebase to not clobber any other changes

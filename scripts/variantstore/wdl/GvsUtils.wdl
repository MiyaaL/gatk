...
task GetToolVersions {
  ...
  output {
    ...
    String variants_docker = "us.gcr.io/broad-dsde-methods/variantstore:2023-10-03-alpine-f7e85890e" ## TODO remember to fetch and rebase to not clobber any other changes
